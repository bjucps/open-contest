...
echo "OC_MAX_CONCURRENT_SUBMISSIONS=$OC_MAX_CONCURRENT_SUBMISSIONS"
echo "OC_MONITORING=$OC_MONITORING"
echo "OC_STATIC_CACHE_SECS=$OC_STATIC_CACHE_SECS"
...
RUNCMD="docker run \
    ...
    -e OC_MAX_CONCURRENT_SUBMISSIONS=$OC_MAX_CONCURRENT_SUBMISSIONS \
    -e OC_MONITORING=$OC_MONITORING \
    -e OC_STATIC_CACHE_SECS=$OC_STATIC_CACHE_SECS \
    --name $NAME \
    $OC_DOCKERIMAGE_BASE \
    $LOGTOFILE \
    $DISABLE_REQ_LOG" 
